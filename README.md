...
| **ts-foundation-features** | Time series embeddings from pre-trained foundation models (PatchTST, PatchTST-FM, Chronos, TimesFM, Timer), a reprogrammed-LLM backend (Time-LLM), a native self-supervised encoder (TS2Vec) and a native torch baseline (DLinear), under one sklearn-style API | 3.11+ | [🔗 repo](https://github.com/BiondaR/ts-foundation-features) |
